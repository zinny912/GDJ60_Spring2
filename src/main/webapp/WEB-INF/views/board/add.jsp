...
<div class="container fluid">	
	...
	<div class="row justify-content-center my-4">
	<!-- 같은 위치의 add로 POST 메서드 형식으로 보낼거임 -->
		<form action="./add" method="POST" enctype="multipart/form-data"> 
			 ...
			 <div class="input-group mb-3">
			  ...
			  <input type="text" name="writer" readonly value="${member.id}" class="form-control border border-3 border border-warning text-body-tertiary" id="writer" aria-label="Username" aria-describedby="basic-addon1">
			</div>
