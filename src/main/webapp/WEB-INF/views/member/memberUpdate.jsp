	...
	<div class="row">
		...
		<form class="row col-6" action="./memberUpdate" method="post"> 
				...
				<div class="input-group mb-3">
				  ...
				  <input type="text" id="names" name="names" class="form-control border border-3 border border-danger text-body-tertiary" value="${dto.names}" placeholder="이름입력" aria-label="Username" aria-describedby="basic-addon1">
				</div>
				<div class="input-group mb-3">
